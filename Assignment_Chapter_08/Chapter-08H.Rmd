...
output: 
  html_document: 
    keep_md: yes
---
### can motify setting so not as much reporting
...
can also use log scale to get a better picture of what is doing.
...
can use randomize code to get new sizes....
