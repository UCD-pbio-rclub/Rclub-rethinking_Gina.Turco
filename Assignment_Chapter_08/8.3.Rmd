...
The effective number of samples are the minimum number of samples needed for the MCMC to predict the shape of the posterior. 
...
m8.7stan <- map2stan(
    alist(
        ...
        bAR ~ dnorm(0,10),
        sigma ~ dcauchy(0,1)
), data=dd.trim, chains=1 , iter=4000 , warmup=1000 ) 
